...
//            m_pWeather_Routing->m_ConfigurationDialog.m_cbUseGrib->Enable();
    ...
    if(message_id == _T("GRIB_TIMELINE_RECORD"))
    {
        ...
        if(!shown_warnings) {
            ...
            if(grib_version < 2003 || grib_version > 4100) {
        ...
        if(m_pWeather_Routing) {
            ...
            if(routemapoverlay) {
                ...
                routemapoverlay->ReceivedGrib(gptr);
    ...
    if(message_id == _T("CLIMATOLOGY"))
    {
        ...
        if(!shown_warnings) {
            ...
            if(major > CLIMATOLOGY_MAX_MAJOR || (major == CLIMATOLOGY_MAX_MAJOR && minor > CLIMATOLOGY_MAX_MINOR)) {
                wxMessageDialog mdlg(m_parent_window,
            ...
            if(major == CLIMATOLOGY_MIN_MAJOR && minor < CLIMATOLOGY_MIN_MINOR) {
                wxMessageDialog mdlg(m_parent_window,
