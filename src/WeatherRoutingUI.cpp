...
ConfigurationDialogBase::ConfigurationDialogBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_sMaxSwellMeters = new wxSpinCtrl( m_panel12, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 100, 20 );
	...
	m_tFromDegrees = new wxTextCtrl( this, wxID_ANY, _("0"), wxDefaultPosition, wxSize( 40,-1 ), 0 );
	...
	m_tToDegrees = new wxTextCtrl( this, wxID_ANY, _("180"), wxDefaultPosition, wxSize( 40,-1 ), 0 );
...
BoatDialogBase::BoatDialogBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_sWindSpeed = new wxSpinCtrl( m_panel3, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 50,-1 ), wxSP_ARROW_KEYS, 1, 60, 15 );
