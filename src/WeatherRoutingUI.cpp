...
WeatherRoutingBase::WeatherRoutingBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_lPositions = new wxListCtrl( sbSizer30->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxSize( 180,-1 ), wxLC_HRULES|wxLC_REPORT|wxLC_SINGLE_SEL|wxHSCROLL|wxVSCROLL );
	...
	m_lWeatherRoutes = new wxListCtrl( sbSizer29->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxSize( -1,100 ), wxLC_HRULES|wxLC_NO_SORT_HEADER|wxLC_REPORT|wxHSCROLL|wxVSCROLL );
...
SettingsDialogBase::SettingsDialogBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_staticText74 = new wxStaticText( sbSizer25->GetStaticBox(), wxID_ANY, _("Cursor Route Color"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText74->Wrap( -1 );
	fgSizer42->Add( m_staticText74, 0, wxALL, 5 );
	
	m_cpCursorRoute = new wxColourPickerCtrl( sbSizer25->GetStaticBox(), wxID_ANY, wxColour( 255, 255, 0 ), wxDefaultPosition, wxDefaultSize, wxCLRP_DEFAULT_STYLE );
	fgSizer42->Add( m_cpCursorRoute, 0, wxALL, 5 );
	
	m_staticText73 = new wxStaticText( sbSizer25->GetStaticBox(), wxID_ANY, _("Destination Route Color"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText73->Wrap( -1 );
	fgSizer42->Add( m_staticText73, 0, wxALL, 5 );
	
	m_cpDestinationRoute = new wxColourPickerCtrl( sbSizer25->GetStaticBox(), wxID_ANY, wxColour( 255, 0, 255 ), wxDefaultPosition, wxDefaultSize, wxCLRP_DEFAULT_STYLE );
	fgSizer42->Add( m_cpDestinationRoute, 0, wxALL, 5 );
	
	m_staticText75 = new wxStaticText( sbSizer25->GetStaticBox(), wxID_ANY, _("Route Thickness"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText75->Wrap( -1 );
	fgSizer42->Add( m_staticText75, 0, wxALL, 5 );
	
	m_sRouteThickness = new wxSpinCtrl( sbSizer25->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 10, 4 );
	fgSizer42->Add( m_sRouteThickness, 0, wxALL, 5 );
	
	m_staticText70 = new wxStaticText( sbSizer25->GetStaticBox(), wxID_ANY, _("Iso Chron Thickness"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText70->Wrap( -1 );
	fgSizer42->Add( m_staticText70, 0, wxALL, 5 );
	
	m_sIsoChronThickness = new wxSpinCtrl( sbSizer25->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 10, 2 );
	fgSizer42->Add( m_sIsoChronThickness, 0, wxALL, 5 );
	
	m_staticText71 = new wxStaticText( sbSizer25->GetStaticBox(), wxID_ANY, _("Alternate Routes Thickness"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_cbMarkAtSailChange = new wxCheckBox( sbSizer25->GetStaticBox(), wxID_ANY, _("Display mark when Sail Plan changes"), wxDefaultPosition, wxDefaultSize, 0 );
...
ConfigurationDialogBase::ConfigurationDialogBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_tStartHour = new wxTextCtrl( sbSizer3->GetStaticBox(), wxID_ANY, _("0"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_sFromDegree = new wxSpinCtrl( sbSizer7->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 60,-1 ), wxSP_ARROW_KEYS, 0, 180, 0 );
	...
	m_sToDegree = new wxSpinCtrl( sbSizer7->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 60,-1 ), wxSP_ARROW_KEYS, 0, 180, 180 );
	...
	m_notebook4 = new wxNotebook( sbSizer23->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_notebook41 = new wxNotebook( sbSizer28->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_bEditBoat = new wxButton( sbSizer24->GetStaticBox(), wxID_ANY, _("Edit"), wxDefaultPosition, wxSize( 40,-1 ), 0 );
	...
	m_cbAllowDataDeficient = new wxCheckBox( sbSizer15->GetStaticBox(), wxID_ANY, _("Last Valid Wind Data if Deficient"), wxDefaultPosition, wxDefaultSize, wxCHK_3STATE );
...
BoatDialogBase::BoatDialogBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_lBoatPlans = new wxListCtrl( sbSizer31->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxSize( -1,-1 ), wxLC_EDIT_LABELS|wxLC_REPORT|wxLC_SINGLE_SEL );
	...
	m_bNewBoatPlan = new wxButton( sbSizer31->GetStaticBox(), wxID_ANY, _("New"), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer40->Add( m_bNewBoatPlan, 0, wxALL, 5 );
	
	m_bDeleteBoatPlan = new wxButton( sbSizer31->GetStaticBox(), wxID_ANY, _("Delete"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_cPlotType = new wxChoice( sbSizer37->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize, m_cPlotTypeNChoices, m_cPlotTypeChoices, 0 );
	...
	m_sWindSpeed = new wxSpinCtrl( sbSizer8->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 50,-1 ), wxSP_ARROW_KEYS, 1, 60, 15 );
	...
	m_sWindDirection = new wxSpinCtrl( sbSizer36->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 359, 90 );
	...
	m_cPlotVariable = new wxChoice( sbSizer7->GetStaticBox(), wxID_ANY, wxDefaultPosition, wxDefaultSize, m_cPlotVariableNChoices, m_cPlotVariableChoices, 0 );
	...
	m_stTrueWindAngle = new wxStaticText( sbSizer6->GetStaticBox(), wxID_ANY, _("0"), wxDefaultPosition, wxSize( 40,-1 ), 0 );
	m_stTrueWindAngle->Wrap( -1 );
	fgSizer20->Add( m_stTrueWindAngle, 0, wxALL, 5 );
	
	m_staticText21 = new wxStaticText( sbSizer6->GetStaticBox(), wxID_ANY, _("Deg"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText21->Wrap( -1 );
	fgSizer20->Add( m_staticText21, 0, wxALL, 5 );
	
	m_stTrueWindKnots = new wxStaticText( sbSizer6->GetStaticBox(), wxID_ANY, _("0"), wxDefaultPosition, wxSize( 40,-1 ), 0 );
	m_stTrueWindKnots->Wrap( -1 );
	fgSizer20->Add( m_stTrueWindKnots, 0, wxALL, 5 );
	
	m_staticText23 = new wxStaticText( sbSizer6->GetStaticBox(), wxID_ANY, _("Knots"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText23->Wrap( -1 );
	...
	m_stApparentWindAngle = new wxStaticText( sbSizer61->GetStaticBox(), wxID_ANY, _("0"), wxDefaultPosition, wxSize( 40,-1 ), 0 );
	m_stApparentWindAngle->Wrap( -1 );
	fgSizer201->Add( m_stApparentWindAngle, 0, wxALL, 5 );
	
	m_staticText211 = new wxStaticText( sbSizer61->GetStaticBox(), wxID_ANY, _("Deg"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText211->Wrap( -1 );
	fgSizer201->Add( m_staticText211, 0, wxALL, 5 );
	
	m_stApparentWindKnots = new wxStaticText( sbSizer61->GetStaticBox(), wxID_ANY, _("0"), wxDefaultPosition, wxSize( 40,-1 ), 0 );
	m_stApparentWindKnots->Wrap( -1 );
	fgSizer201->Add( m_stApparentWindKnots, 0, wxALL, 5 );
	
	m_staticText231 = new wxStaticText( sbSizer61->GetStaticBox(), wxID_ANY, _("Knots"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_stBoatAngle = new wxStaticText( sbSizer62->GetStaticBox(), wxID_ANY, _("0"), wxDefaultPosition, wxSize( 40,-1 ), 0 );
	m_stBoatAngle->Wrap( -1 );
	fgSizer202->Add( m_stBoatAngle, 0, wxALL, 5 );
	
	m_staticText212 = new wxStaticText( sbSizer62->GetStaticBox(), wxID_ANY, _("Deg"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText212->Wrap( -1 );
	fgSizer202->Add( m_staticText212, 0, wxALL, 5 );
	
	m_stBoatKnots = new wxStaticText( sbSizer62->GetStaticBox(), wxID_ANY, _("0"), wxDefaultPosition, wxSize( 40,-1 ), 0 );
	m_stBoatKnots->Wrap( -1 );
	fgSizer202->Add( m_stBoatKnots, 0, wxALL, 5 );
	
	m_staticText232 = new wxStaticText( sbSizer62->GetStaticBox(), wxID_ANY, _("Knots"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText961 = new wxStaticText( m_sbComputationTransform->GetStaticBox(), wxID_ANY, _("Eta"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText961->Wrap( -1 );
	fgSizer53->Add( m_staticText961, 0, wxALL, 5 );
	
	m_sEta = new wxSlider( m_sbComputationTransform->GetStaticBox(), wxID_ANY, 500, 1, 1000, wxDefaultPosition, wxDefaultSize, wxSL_HORIZONTAL );
	fgSizer53->Add( m_sEta, 0, wxALL|wxEXPAND, 5 );
	
	m_tEta = new wxTextCtrl( m_sbComputationTransform->GetStaticBox(), wxID_ANY, _("0.25"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	sbSizer14 = new wxStaticBoxSizer( new wxStaticBox( m_sbComputationTransform->GetStaticBox(), wxID_ANY, _("Drag") ), wxVERTICAL );
	...
	m_staticText35 = new wxStaticText( sbSizer14->GetStaticBox(), wxID_ANY, _("Frictional"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText35->Wrap( -1 );
	fgSizer57->Add( m_staticText35, 0, wxALL, 5 );
	
	m_sFrictionalDrag = new wxSpinCtrl( sbSizer14->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 60,-1 ), wxSP_ARROW_KEYS, 0, 100, 0 );
	fgSizer57->Add( m_sFrictionalDrag, 0, wxALL, 5 );
	
	m_staticText112 = new wxStaticText( sbSizer14->GetStaticBox(), wxID_ANY, _("Wake"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText112->Wrap( -1 );
	fgSizer57->Add( m_staticText112, 0, wxALL, 5 );
	
	m_sWakeDrag = new wxSpinCtrl( sbSizer14->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 60,-1 ), wxSP_ARROW_KEYS, 0, 100, 0 );
	fgSizer57->Add( m_sWakeDrag, 0, wxALL, 5 );
	
	m_bRecomputeDrag = new wxButton( sbSizer14->GetStaticBox(), wxID_ANY, _("Recompute"), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer57->Add( m_bRecomputeDrag, 0, wxALL, 5 );
	
	m_bDragInfo = new wxButton( sbSizer14->GetStaticBox(), wxID_ANY, _("Info"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText91 = new wxStaticText( m_sbComputationTransform->GetStaticBox(), wxID_ANY, _("Max Pointing Angle Apparent Wind"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText91->Wrap( -1 );
	fgSizer541->Add( m_staticText91, 0, wxALL, 5 );
	
	m_sLuffAngle = new wxSpinCtrl( m_sbComputationTransform->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( 50,-1 ), wxSP_ARROW_KEYS, 0, 180, 15 );
	fgSizer541->Add( m_sLuffAngle, 0, wxALL, 5 );
	
	m_cbWingWingRunning = new wxCheckBox( m_sbComputationTransform->GetStaticBox(), wxID_ANY, _("Wing and Wing Running"), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer541->Add( m_cbWingWingRunning, 0, wxALL, 5 );
	
	m_bSaveFile = new wxButton( m_sbComputationTransform->GetStaticBox(), wxID_ANY, _("Save As CSV"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText131 = new wxStaticText( m_sbComputationIMF->GetStaticBox(), wxID_ANY, _("Based on general formula\nSpeed = 2.62 + 0.066*SA/D ratio + 0.51*LWL feet"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText131->Wrap( -1 );
	...
	m_staticText93 = new wxStaticText( m_sbFile->GetStaticBox(), wxID_ANY, _("FileName"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText93->Wrap( -1 );
	fgSizer34->Add( m_staticText93, 0, wxALL, 5 );
	
	m_fpFilePath = new wxFilePickerCtrl( m_sbFile->GetStaticBox(), wxID_ANY, wxEmptyString, _("Select a file"), wxT("CSV, POL, TXT (*.csv, *.pol *.txt)|*.CSV;*.csv;*.csv.gz;*.csv.bz2;*.POL;*.pol;*.pol.gz;*.pol.bz2;*.TXT;*.txt;*.txt.gz;*.txt.bz2|All files (*.*)|*.*"), wxDefaultPosition, wxDefaultSize, wxFLP_DEFAULT_STYLE|wxFLP_USE_TEXTCTRL );
	fgSizer34->Add( m_fpFilePath, 0, wxALL|wxEXPAND, 5 );
	
	m_staticText123 = new wxStaticText( m_sbFile->GetStaticBox(), wxID_ANY, _("Wind Speed Step"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText123->Wrap( -1 );
	fgSizer34->Add( m_staticText123, 0, wxALL, 5 );
	
	m_stWindSpeedStep = new wxStaticText( m_sbFile->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	m_stWindSpeedStep->Wrap( -1 );
	fgSizer34->Add( m_stWindSpeedStep, 0, wxALL, 5 );
	
	m_staticText125 = new wxStaticText( m_sbFile->GetStaticBox(), wxID_ANY, _("Wind Degree Step"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText125->Wrap( -1 );
	fgSizer34->Add( m_staticText125, 0, wxALL, 5 );
	
	m_stWindDegreeStep = new wxStaticText( m_sbFile->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
...
SwitchPlanDialogBase::SwitchPlanDialogBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_cbMaxWindSpeed = new wxCheckBox( sbSizer15->GetStaticBox(), wxID_ANY, _("Wind Speed >"), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer52->Add( m_cbMaxWindSpeed, 0, wxALL, 5 );
	
	m_sMaxWindSpeed = new wxSpinCtrl( sbSizer15->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 100, 0 );
	fgSizer52->Add( m_sMaxWindSpeed, 0, wxALL, 5 );
	
	m_staticText101 = new wxStaticText( sbSizer15->GetStaticBox(), wxID_ANY, _("Knots"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText101->Wrap( -1 );
	fgSizer52->Add( m_staticText101, 0, wxALL, 5 );
	
	m_cbMinWindSpeed = new wxCheckBox( sbSizer15->GetStaticBox(), wxID_ANY, _("Wind Speed <"), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer52->Add( m_cbMinWindSpeed, 0, wxALL, 5 );
	
	m_sMinWindSpeed = new wxSpinCtrl( sbSizer15->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 100, 0 );
	fgSizer52->Add( m_sMinWindSpeed, 0, wxALL, 5 );
	
	m_staticText102 = new wxStaticText( sbSizer15->GetStaticBox(), wxID_ANY, _("Knots"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText102->Wrap( -1 );
	fgSizer52->Add( m_staticText102, 0, wxALL, 5 );
	
	m_cbMaxWindDirection = new wxCheckBox( sbSizer15->GetStaticBox(), wxID_ANY, _("Wind Direction >"), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer52->Add( m_cbMaxWindDirection, 0, wxALL, 5 );
	
	m_sMaxWindDirection = new wxSpinCtrl( sbSizer15->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 180, 0 );
	fgSizer52->Add( m_sMaxWindDirection, 0, wxALL, 5 );
	
	m_staticText103 = new wxStaticText( sbSizer15->GetStaticBox(), wxID_ANY, _("Degrees"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText103->Wrap( -1 );
	fgSizer52->Add( m_staticText103, 0, wxALL, 5 );
	
	m_cbMinWindDirection = new wxCheckBox( sbSizer15->GetStaticBox(), wxID_ANY, _("Wind Direction <"), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer52->Add( m_cbMinWindDirection, 0, wxALL, 5 );
	
	m_sMinWindDirection = new wxSpinCtrl( sbSizer15->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 180, 0 );
	fgSizer52->Add( m_sMinWindDirection, 0, wxALL, 5 );
	
	m_staticText104 = new wxStaticText( sbSizer15->GetStaticBox(), wxID_ANY, _("Degrees"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText104->Wrap( -1 );
	fgSizer52->Add( m_staticText104, 0, wxALL, 5 );
	
	m_cbMaxWaveHeight = new wxCheckBox( sbSizer15->GetStaticBox(), wxID_ANY, _("Wave Height >"), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer52->Add( m_cbMaxWaveHeight, 0, wxALL, 5 );
	
	m_sMaxWaveHeight = new wxSpinCtrl( sbSizer15->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 10, 0 );
	fgSizer52->Add( m_sMaxWaveHeight, 0, wxALL, 5 );
	
	m_staticText105 = new wxStaticText( sbSizer15->GetStaticBox(), wxID_ANY, _("Meters"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText105->Wrap( -1 );
	fgSizer52->Add( m_staticText105, 0, wxALL, 5 );
	
	m_cbMinWaveHeight = new wxCheckBox( sbSizer15->GetStaticBox(), wxID_ANY, _("Wave Height <"), wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer52->Add( m_cbMinWaveHeight, 0, wxALL, 5 );
	
	m_sMinWaveHeight = new wxSpinCtrl( sbSizer15->GetStaticBox(), wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 10, 0 );
	fgSizer52->Add( m_sMinWaveHeight, 0, wxALL, 5 );
	
	m_staticText106 = new wxStaticText( sbSizer15->GetStaticBox(), wxID_ANY, _("Meters"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText106->Wrap( -1 );
	fgSizer52->Add( m_staticText106, 0, wxALL, 5 );
	
	m_cbDayTime = new wxCheckBox( sbSizer15->GetStaticBox(), wxID_ANY, _("Day Time"), wxDefaultPosition, wxDefaultSize, 0 );
	m_cbDayTime->SetValue(true); 
	fgSizer52->Add( m_cbDayTime, 0, wxALL, 5 );
	
	m_cbNightTime = new wxCheckBox( sbSizer15->GetStaticBox(), wxID_ANY, _("Night Time"), wxDefaultPosition, wxDefaultSize, 0 );
