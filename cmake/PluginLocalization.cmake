...
if(GETTEXT_XGETTEXT_EXECUTABLE)
  add_custom_command(
    ...
    COMMAND
      ${GETTEXT_XGETTEXT_EXECUTABLE} --force-po -F --package-name=${PACKAGE_NAME} --package-version="${PACKAGE_VERSION}" --output=po/${PACKAGE_NAME}.pot --keyword=_ --width=80
...
macro(GETTEXT_UPDATE_PO _potFile)
  ...
  foreach(_currentPoFile ${ARGN})
    ...
    add_custom_command(
      ...
      COMMAND
        ${GETTEXT_MSGMERGE_EXECUTABLE} --width=80 --strict --quiet --update --backup=none --no-location -s ${_absFile} ${_absPotFile}
