...
* Your boat's xref:#_boat_performance_data_polar_data[Boat Performance Data - Polar Data] or xref:#_boat_performance_data_outside_sources[Outside Polar File Sources]. Accuracy in given conditions is significant. 
