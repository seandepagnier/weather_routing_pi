...
. xref::opencpn-plugins:misc:help_information.adoc[Help > Information]
...
. xref::opencpn-plugins:misc:help_information.adoc[Help > Information Menu] (Configuration) Menus and Definitions 
